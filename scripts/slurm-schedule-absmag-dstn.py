...
def task(run, event_id):
    ...
    cmdline = f"schedule --mission=uvex --bandpass=NUV --deadline=6hour --timelimit=2hour --memory=10GiB --absmag-mean=-12.4 --exptime-min=300s --nside=128 --cutoff=0.1 --jobs={job_cpu} data/{run}/{event_id}.fits data/{run}/{event_id}.ecsv"
